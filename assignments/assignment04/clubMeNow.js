...
function loadClubDistances() {
	...
	const WARNING = "Warning: you are only allowed to carry 14 clubs in your golf bag in match play competition."
	...
	if(clubs.length > 14) window.alert(WARNING)
	return clubs;
}
...
function undoLastShot() {
	let clubs = localStorage.getItem('clubsUndo')
...
function displayAbout() {
	window.alert('This application is for managing which clubs you will take into a tournament.')
}
